                                ...
                                <div className="bg-gray-50 rounded-xl p-4 space-y-1 text-sm">
                                    ...
                                    {selectedOrder.address?.phone && (
                                        <a
                                            ...
                                            className="inline-flex items-center gap-1.5 mt-2 px-3 py-1.5 bg-[#25D366] hover:bg-[#128C7E] text-white rounded-lg text-xs font-bold transition-colors shadow-sm"
                                        >
